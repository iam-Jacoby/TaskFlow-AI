          ...
          <CardContent>
            <div className="space-y-4">
              {analytics.categoryData.map((category) => {
                const percentage =
                  category.tasks > 0
                    ? Math.round((category.completed / category.tasks) * 100)
                    : 0;
              ...
              <div className="space-y-4">
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground">
                      Friday shows highest completion rates (83%)
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground">
                      Testing tasks have lower completion rates
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground">
                      12% improvement in task completion this week
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground">
                      Average task completion improved by 15%
                    </p>
                  </div>
                </div>
              </div>
